    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <div class="row">
          <div class="col-sm-12">
            <div class="card-box ">
              <form class="form-group report_validate" action="{{url('closedaccountreports')}}" method="post" target="_blank">
                @csrf
                <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                  <label>{{trans('language.th_providing_retirment_year')}}</label>
                  <input class="form-control" type="text" name="retirment_year" id="retirment_year">
                </div>
                <div class="col-sm-2">
                  <label>{{trans('language.th_providing_retirment_month')}}</label>
                  <select class="form-control" type="text" name="retirment_month" id="retirment_month">
                    <option value="" disabled selected> Select Month</option>
                    @foreach($month AS $m_row)
...
@endsection
@push('custom-scripts')
<script type="text/javascript" src="{{URL('js/closedaccountreports.js')}}"></script>
@endpush
