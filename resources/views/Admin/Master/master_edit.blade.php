					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
                                    <form class="form-horizontal form-label-left" action="{{url('/Update_master')}}"
                    ...
                    {{csrf_field()}}
                                           ...
                                           <div class="field item form-group">
                                              ...
                                              <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="bank_name"   value="{{$master->bank_name}}"  class='classification'>
