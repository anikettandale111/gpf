                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form   class="form-horizontal form-label-left" action="{{url('/Year_Insert_Data')}}"method="POST"  enctype="multipart/form-data" novalidate>
                                            {{csrf_field()}}
                                    ...
                                    <select name="year" class="form-control">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional'  id="dd1 "name="percent" data-validate-length-range="5,15" type="text" /></div>
                                        </div>
                                      <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">पासून <span class="required">*</span></label>
                                          <div class="col-md-6 col-sm-6">
                                          <select class="form-control"
                                              type="time" name="from_month" id="from_month" required='required'>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select class="form-control"
                                                type="time" name="to_month" id="to_month" required='required'>
                                                 @foreach ($Month as $month)
                                              <option>{{$month->name}}</option>
                                              @endforeach
                                                </select>
