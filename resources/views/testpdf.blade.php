...
<div class="row">
                ...
                <form class="form_users_excel_file" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-3 file-select">
                      ...
                      <input class="form-control" type="file" name="test_pdf" id="test_pdf" required>
                    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card-box table-responsive">
          <table id="pdf_file_upload_list" class="table table-striped table-bordered " style="width:100% !important">
            <thead>
              <tr>
                <th> क्रं </th>
                <th>वर्ष </th>
  ...
  <div class="x_content hide showdummy" >
    <form class="dummy_entry_form" method="post">
    <div class="row">
      <div class="col-sm-12">
        <div class="card-box table-responsive">
          <table id="pdf_file_upload_dummy_entry" class="table table-striped table-bordered " style="width:100% !important">
            <thead>
              <tr>
                <th> क्रं </th>
                <th>भ.नि.नि.क्रमांक</th>
...
@endsection
@push('custom-scripts')
<script type="text/javascript" src="{{URL('js/pdffileupload.js')}}"></script>
@endpush
